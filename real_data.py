...
raw_data = pd.read_csv('Traffic-Modelling/Data/2014 TMU Site 30014795 (AL1850).csv')
...
plt.title('Average speed of car vs number of cars on the A31 between M27 J1 and A338', fontsize = 15)
